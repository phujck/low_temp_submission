...
What defines equilibrium? In closed quantum statistical mechanics, equilibrium is given by the Gibbs state associated with the system Hamiltonian: $\rho \propto e^{-\beta H}$. For an open system with finite coupling, the operationally defined equilibrium state of the subsystem is the
...
of renormalized fsystem Hamiltonians. At finite coupling, equilibrium
