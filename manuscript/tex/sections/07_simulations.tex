...
\end{align}
No counterterm is included, so the renormalisation is explicitly visible in
...
\end{equation}
and is discretised into a finite mode set used in ED and in stochastic sampling.
...
The discretised and continuum renormalisation scales are
\begin{equation}
\lambda_{\mathrm{disc}}
=
...
\end{enumerate}
All reported states are explicitly reorganised to unit trace before extracting
observables.
...
localised to the coupled projector sector, while agreement with ED is maintained.
...
This tests whether strong-coupling behaviour remains controlled by the projected
interaction term predicted by Eq.~\eqref{eq:hmf_projector_form}.

\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{../../simulations/results/figures/lt_cg_2.pdf}
