...
\begin{equation}
    ...
    \label{eq:Htot_full}
\end{equation}
As is standard in Caldeira--Leggett constructions, one may include a counterterm
...
the coupling. In what follows we absorb any such counterterm into the
definition of $H_Q$.
...
\end{equation}
which compactly encodes the bath two-point structure and fixes the imaginary-time
influence kernel used below.
